...
void DoRunMyJob (const int events, const int dataset=0, const int stupleVer=7)
{
	...
	int MCFLAG = 0;
	if (dataset != 1 && dataset != 50) MCFLAG = 1;
	...
	if (stupleVer == 7)
	{
		...
		{
			std::cout << "Using V8 PHO DATA with b-Tag Info ("<< stupleVer << ")"  << std::endl;
			ch->Add("~/4c/bTagSTUPLES/StupleV9_PhoData_1P4_NoJetVtxCuts_bTagInfo.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_5P10_NoJetVtxCuts_bTagInfo.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_11P13_NoJetVtxCuts_bTagInfo.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_14P17_NoJetVtxCuts_bTagInfo.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_1.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_2.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_3.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_4.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_5.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_6.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_7.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_8.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_9.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_10.root");
			ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_11.root");
			
			//ch->Add("~/4c/bTagSTUPLES/StupleV8_PhoData_18P28_NoJetVtxCuts_bTagInfo_12.root");
		} else if (dataset == 70) //costas Wgamma sample for Bukley's work
		{
			std::cout << "Using V8 Wg MC" << std::endl;
			ch->Add("~/STUPLES4/StupleV8_MCPytMad_Wg_NoJetVtxCuts.root");
		} else if (dataset == 80) //costas Zgamma sample for Bukley's work
		{
			std::cout << "Using V8 Zg MC" << std::endl;
			ch->Add("~/STUPLES4/StupleV8_MCPytMad_Zg_NoJetVtxCuts.root");
		}
