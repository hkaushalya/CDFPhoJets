...
void MergeMetHists(const int metsig, const int iNfiles, const int Incl, const int jetcut, const int debug)
{
	...
	std::stringstream file4, file5, file6, file7, file8;


	if (Incl == 1)  //incl njet15
	{
		std::cout << "Using njet>=" << jetcut << "GeV settings." << std::endl;
		title1 << "PYTHIA #gamma^{DetEta<0.95}_{signal}+>=1 jet^{E_{T}>="<< jetcut << "GeV, DetEta<3.0} : Pseudo Expts=1, #slash{E}_{T}-Sig>" << metsig;
		title2 << "PYTHIA #gamma^{DetEta<0.95}_{signal}+>=1 jet^{E_{T}>="<< jetcut << "GeV, DetEta<3.0} : Pseudo Expts=1";
		file  << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_NJet15.gif";
		file1 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_MetAll.gif";
		file2 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_Met.gif";
		file3 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_MetSig.gif";
		file4 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_JEt.gif";
		file5 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_PhoEt.gif";
		file6 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_DelPhiPhoMet.gif";
		file7 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_DelPhiJetMet.gif";
		file8 << "PhoMCSignal_InclNJet" << jetcut<<"_MetSig"<< metsig << "_Ht.gif";
	...
	if (Incl == 0)  //excl njet15
	{
		...
		title1 << "PYTHIA #gamma^{DetEta<0.95}_{signal}+=1 jet^{E_{T}>="<< jetcut<< "GeV, DetEta<3.0} : Pseudo Expts=1, #slash{E}_{T}-Sig>" << metsig;
		title2 << "PYTHIA #gamma^{DetEta<0.95}_{signal}+=1 jet^{E_{T}>="<< jetcut << "GeV, DetEta<3.0} : Pseudo Expts=1";
		file  << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_NJet15.gif";
		file1 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_MetAll.gif";
		file2 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_Met.gif";
		file3 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_MetSig.gif";
		file4 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_JEt.gif";
		file5 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_PhoEt.gif";
		file6 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_DelPhiPhoMet.gif";
		file7 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_DelPhiJetMet.gif";
		file8 << "PhoMCSignal_ExclNJet" << jetcut<<"_MetSig"<< metsig << "_Ht.gif";
	...
	//if (metsig == 2)
	{
//		MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title1.str(), "MetAll",-1,-1,4, file1.str(), metsig, debug,1);
	}

	//	if (metsig == 2)
	{
//		MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title2.str(), "MetSig",-1,-1,4, file3.str(), metsig, debug,1);
	}
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title1.str(), "Met",-1,-1,4, file2.str(), metsig, debug,1);

	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title4.str(), "Etjet",-1,-1,4, file4.str(), metsig, debug);
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title1.str(), "Njet15",-1,-1,1, file.str(), metsig, debug);
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title4.str(), "dPhi1",-1,-1,4, file6.str(), metsig, debug);
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title4.str(), "Et1",-1,-1,4, file5.str(), metsig, debug);
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title4.str(), "dPhi3",-1,-1,4, file7.str(), metsig, debug);
//	MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title4.str(), "Ht",-1,-1,4, file8.str(), metsig, debug);
	//MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title1.str(), "Et_a[0]",-1,-1,5, file1.str(), metsig, debug);
	//MergeMetHists (iNfiles,"MetTest_PhotonMC.root_",title1.str(), "Et_a[1]",-1,-1,5, file2.str(), metsig, debug);
