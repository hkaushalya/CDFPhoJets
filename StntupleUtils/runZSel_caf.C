...
#include "TSystem.h"
#include "samantha/samantha/Pho/ZSel.hh"
#include "samantha/samantha/Pho/TagConvElectrons.hh"

/////////////////////////////////////////////////////////////

void runZSel_caf(const int nEvts = 100, const int dataset = 10,
							...
							const int NcafSections=20) 
{
   ...
   jf->SetDebug(0);
	...
	ZSel *zsel = new ZSel();
	zsel->SetMaxDetEta(3.0);
	zsel->SetMinEleEt(20.0);
	//zsel->SetSummaryStat(bSummaryStat);		//1=disable 0=enable endjob summary
	zsel->SetDataSample(dataset);
	zsel->UseNvtxWeigts(0);
	...
	file << "ZSel_" << suffix <<"_" << cafind << "_" << NcafSections << ".root";
