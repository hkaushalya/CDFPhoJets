#ifndef HALOBYCUTSTEMP_ELE_HH
#define HALOBYCUTSTEMP_ELE_HH
...
class HaloByCutsTemp_Ele: public TStnModule {
	...
	public:
		HaloByCutsTemp_Ele(const char* name="HaloByCutsTemp_Ele", const char* title="HaloByCutsTemp_Ele");
		~HaloByCutsTemp_Ele();
