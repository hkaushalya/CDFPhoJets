#ifndef LOOSEELECTRONTEMPLATE_HH
#define LOOSEELECTRONTEMPLATE_HH
...
class LooseElectronTemplate: public TStnModule {
	...
	public:
		LooseElectronTemplate(const char* name="LooseElectronTemplate", const char* title="LooseElectronTemplate");
		~LooseElectronTemplate();
	...
	ClassDef(LooseElectronTemplate,1)
};
